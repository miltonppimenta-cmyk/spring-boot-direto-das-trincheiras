...
public class HeroController {
    ...
    @GetMapping("filter")
    public List<String> listAllHeroesParam(@RequestParam(/*pode ser com o valor defaultValue="")*/required = false) String name) {
        return HEROES.stream().filter(hero -> hero.equalsIgnoreCase(name)).toList();
    }

    @GetMapping("filterList")
    public List<String> listAllHeroesParam(@RequestParam(/*pode ser com o valor defaultValue="")*/required = false) List<String> names) {
